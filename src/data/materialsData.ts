...
import { EXPANDED_MATERIALS } from './expandedMaterialsData';
...
export const INITIAL_MATERIALS: Material[] = [
  ...
  },
  {
    ...
    appearance: 'Colorless, odorless atmospheric gas composed of diatomic N₂ molecules.',
    conductivity: 'Non-conductive',
    reactivity: 'Low',
    oxidationStates: '-3, +3, +5',
    chemicalBehavior: 'Diatomic N₂ has an exceptionally strong triple covalent bond (945 kJ/mol), giving it very low reactivity at standard conditions. It undergoes condition-dependent reactions at high temperatures, under electrical discharges, or in the industrial Haber-Bosch process with catalysts.',
    interestingFacts: [
  ...
  {
    id: 'sand',
    name: 'Silica Sand (Granular Mineral Mixture)',
    nameAr: 'رمل السيليكا (خليط حبيبي طبيعي)',
    symbol: 'SiO₂ (granular aggregate)',
    category: 'Minerals',
    rarity: 'Common',
    state: 'Solid',
    colorHex: '#fde047',
    ...
    meltingPoint: '1710 °C',
    boilingPoint: '2950 °C',
    appearance: 'Heterogeneous natural granular aggregate of weathered, rounded quartz crystals mixed with mineral impurities (feldspar, clays, iron oxides).',
    conductivity: 'Non-conductive',
    reactivity: 'Low',
    oxidationStates: 'Silicon (+4), Oxygen (-2)',
    chemicalBehavior: 'Natural particulate mechanical mixture rather than a monolithic crystal or single compound; inter-particle porosity accounts for bulk packing density (~1.60 g/cm³). Primary raw material for industrial glassmaking and foundries.',
    interestingFacts: [
  ...
  {
    id: 'glass',
    name: 'Silica Glass (Amorphous Silica)',
    nameAr: 'زجاج السيليكا (السيليكا غير المتبلورة)',
    symbol: 'SiO₂ (amorphous network)',
    category: 'Minerals',
    rarity: 'Common',
    state: 'Solid',
    colorHex: '#e0f2fe',
    ...
    boilingPoint: 'N/A',
    appearance: 'Isotropic, transparent non-crystalline amorphous solid with random network topology and smooth conchoidal fracture.',
    conductivity: 'Non-conductive',
    reactivity: 'Low',
    oxidationStates: 'Neutral network',
    chemicalBehavior: 'Disordered, non-crystalline amorphous network of corner-sharing [SiO₄] tetrahedra lacking long-range periodic lattice symmetry. Does not possess a sharp melting point, instead softening continuously across its glass transition temperature (Tg). Dissolves in concentrated hydrofluoric acid.',
    interestingFacts: [
  ...
  {
    id: 'quartz',
    name: 'Quartz (Crystalline Silica)',
    nameAr: 'الكوارتز (السيليكا البلورية)',
    symbol: 'α-SiO₂ (crystalline)',
    category: 'Minerals',
    rarity: 'Rare',
    state: 'Solid',
    colorHex: '#e0e7ff',
    ...
    meltingPoint: '1713 °C',
    boilingPoint: '2950 °C',
    appearance: 'Trigonal crystalline framework of high optical clarity, vitreous luster, and long-range lattice order.',
    conductivity: 'Non-conductive',
    reactivity: 'Low',
    oxidationStates: 'Silicon (+4), Oxygen (-2)',
    chemicalBehavior: 'Crystalline network polymer of corner-sharing [SiO₄] tetrahedra with precise long-range periodic lattice order; exhibits marked anisotropy, piezoelectricity, and a sharp thermodynamic melting point of 1713 °C.',
    interestingFacts: [
  ...
  // --- SPACE MATTER ---
  {
    id: 'helium_3',
    name: 'Helium-3',
    nameAr: 'هيليوم-3 (نظير الهيليوم-3)',
    symbol: '³He',
    atomicNumber: 2,
    category: 'Space',
    rarity: 'Exotic',
    ...
    appearance: 'Colorless, odorless noble gas; genuine light stable isotope of helium with 2 protons and 1 neutron.',
    conductivity: 'Non-conductive',
    reactivity: 'Inert',
    oxidationStates: '0',
    chemicalBehavior: 'Stable non-radioactive isotope of elemental helium. (Note: In MIXON, it is categorized under "Space" due to its concentration in solar wind and lunar regolith; physically and chemically it is an elemental isotope with closed 1s² electronic duet identical in chemistry to helium-4). Premier theoretical fuel candidate for aneutronic nuclear fusion.',
    interestingFacts: [
  ...
  {
    id: 'cosmic_plasma',
    name: 'Cosmic Hydrogen Plasma (Ionized State)',
    nameAr: 'بلازما الهيدروجين المتأينة',
    symbol: 'H⁺ + e⁻ (Plasma State)',
    category: 'Space',
    rarity: 'Legendary',
    state: 'Plasma',
    colorHex: '#c084fc',
    ...
    conductivity: 'Extremely High (Quasi-neutral ionized plasma)',
    reactivity: 'Very High',
    oxidationStates: 'Ionized',
    chemicalBehavior: 'Fully ionized fourth physical state of matter consisting of unbound protons (H⁺) and free conduction electrons (e⁻). Governed by electrodynamics and magnetohydrodynamic Alfvén waves; not a bonded chemical compound or molecule.',
    interestingFacts: [
